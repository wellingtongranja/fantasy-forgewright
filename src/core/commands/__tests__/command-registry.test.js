...
describe('CommandRegistry', () => {
  ...
  describe('command execution', () => {
    ...
    it('should throw error for unknown command', async () => {
      await expect(registry.executeCommand('unknown')).rejects.toThrow('Command "unknown" not found')
    })
  ...
  describe('parameter validation', () => {
    ...
    it('should validate required parameters', async () => {
      await expect(registry.executeCommand('paramtest')).rejects.toThrow('Missing required parameters: required')
    })
    ...
    it('should validate parameter types', async () => {
      ...
      await expect(registry.executeCommand('paramtest invalid')).rejects.toThrow('Parameter "num" must be of type number')
    })
  })
