 ...
 */
export const fantasyLightTheme = [
  createUnifiedTheme('light'),
  createSyntaxHighlighting('light')
]

export const fantasyDarkTheme = [
  createUnifiedTheme('dark'),
  createSyntaxHighlighting('dark')
]

export const fantasyTheme = [
  createUnifiedTheme('fantasy'),
  createSyntaxHighlighting('fantasy')
]
